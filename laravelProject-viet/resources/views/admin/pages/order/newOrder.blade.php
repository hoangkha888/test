                ...
                <div class="table-responsive">
                    <table id="responsive-data-table" class="table" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                <td>1050</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p1.jpg') }}" alt="product"></td>
                            ...
                            <tr>
                                <td>1049</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p2.jpg') }}" alt="product"></td>
                            ...
                            <tr>
                                <td>1048</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p3.jpg') }}" alt="product"></td>
                            ...
                            <tr>
                                <td>1047</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p4.jpg') }}" alt="product"></td>
                                <td>Cowboy Hat</td>
                            ...
                            <tr>
                                <td>1046</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p5.jpg') }}" alt="product"></td>
                                <td>Womens Purse</td>
                            ...
                            <tr>
                                <td>1045</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p6.jpg') }}" alt="product"></td>
                            ...
                            <tr>
                                <td>1095</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p7.jpg') }}" alt="product"></td>
                                <td>Mens Shirt</td>
                            ...
                            <tr>
                                <td>354</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p8.jpg') }}" alt="product"></td>
                                <td>Smart Watch</td>
                            ...
                            <tr>
                                <td>654</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p9.jpg') }}" alt="product"></td>
                                <td>Tee-Shirt For Men</td>
                            ...
                            <tr>
                                <td>785</td>
                                <td><img class="product-img tbl-img" src="{{ asset('backend/img/products/p10.jpg') }}" alt="product"></td>
