                    ...
                    <div class="table-responsive">
                        <table id="responsive-data-table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u2.jpg') }}" alt="user profile" /></td>
                                    <td>Johnee Bolbi</td>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u3.jpg') }}" alt="user profile" /></td>
                                    <td>Johnee Bolbi</td>
                                    <td>johneebolbi@gmail.com</td>
                                    <td>+5-256-325-8652</td>
                                    <td>5161</td>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u4.jpg') }}" alt="user profile" /></td>
                                    <td>Mohini Marlo</td>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u5.jpg') }}" alt="user profile" /></td>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u6.jpg') }}" alt="user profile" /></td>
                                    <td>Hardi Sandhu</td>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u7.jpg') }}" alt="user profile" /></td>
                                    <td>Bhavlo Malvia</td>
                                ...
                                <tr>
                                    <td><img class="vendor-thumb" src="{{ asset('backend/img/vendor/u8.jpg') }}" alt="user profile" /></td>
                                    <td>Jeni Dusuja</td>
